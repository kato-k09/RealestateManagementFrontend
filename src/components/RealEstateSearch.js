...
const RealEstateSearch = () => {
  ...
  const handleEdit = (property) => {
    ...
    const copiedProperty = {
      ...
      incomeAndExpenses: property.incomeAndExpenses
          ? {...property.incomeAndExpenses} : {
            rent: 0,
            managementFee: 0,
            repairFund: 0,
            maintenanceCost: 0,
  ...
  const calculateMonthlyProfit = (incomeAndExpenses) => {
    ...
    // 融資を考慮する場合のみ元金と利息を追加
    if (!excludeLoan) {
      expenses += (incomeAndExpenses.principal || 0)
  ...
  const calculateGrossYield = (property) => {
    if (!property || !property.incomeAndExpenses
        || !property.incomeAndExpenses.rent) {
      return 0;
    }
  ...
  const calculateTotals = () => {
    ...
    realEstateList.forEach(property => {
      ...
      // 月収支の合計
      totals.monthlyProfit += calculateMonthlyProfit(
          property.incomeAndExpenses);
    });
          ...
          <div
            ...
            <div>
              ...
              <input
                  ...
                  onChange={(e) => setSearchParams(
                      {...searchParams, searchProjectName: e.target.value})}
            ...
            <div>
              ...
              <select
                  ...
                  onChange={(e) => setSearchParams(
                      {...searchParams, searchBuildingType: e.target.value})}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
            ...
            <div>
              ...
              <select
                  ...
                  onChange={(e) => setSearchParams({
                    ...searchParams,
                    searchBuildingStructure: e.target.value
                  })}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
                <option value="">すべて</option>
            ...
            <div>
              ...
              <select
                  value={searchParams.searchFinancing === null ? ''
                      : searchParams.searchFinancing.toString()}
                  onChange={(e) => {
                    ...
                    <div key={index}
                      ...
                      <div className="flex justify-between items-start mb-4">
                        <div className="flex-1">
                          <div className="flex items-center mb-2">
                            ...
                            {((property.incomeAndExpenses?.principal || 0) > 0
                                || (property.incomeAndExpenses?.interest || 0)
                                > 0) && (
                                <span
                                    className="ml-2 px-2 py-1 bg-orange-100 text-orange-800 text-xs font-semibold rounded">
                                融資有り
                              </span>
                            )}
                          </div>
                          ...
                          <div
                              ...
                              <span>
                                {property.building?.buildingDate
                                    ? (calculateBuildingAge(
                                        property.building.buildingDate) === "新築"
                                        ? "新築"
                                        : `築${calculateBuildingAge(
                                            property.building.buildingDate)}年`)
                                    : '築年月日未設定'}
                              </span>
                            </div>
                            ...
                            <div className="flex items-center">
                              ...
                              <span className={calculateMonthlyProfit(
                                  property.incomeAndExpenses) >= 0
                                  ? 'text-green-600' : 'text-red-600'}>
                          月収支: {formatPrice(calculateMonthlyProfit(
                                  property.incomeAndExpenses))}
                        </span>
                            </div>
                      ...
                      <div
                        ...
                        <div className="bg-green-50 p-3 rounded">
                          <div className="font-medium text-green-800">家賃収入
                          </div>
                          <div className="text-green-600">{formatPrice(
                              property.incomeAndExpenses?.rent)}</div>
                        </div>
                        <div className="bg-purple-50 p-3 rounded">
                          <div className="font-medium text-purple-800">支出
                          </div>
                          <div className="text-purple-600">
                            {formatPrice(
                                ...
                                +
                                (property.incomeAndExpenses?.repairFund || 0) +
                                (property.incomeAndExpenses?.maintenanceCost
                                    || 0) +
                                (!excludeLoan
                                    ? ((property.incomeAndExpenses?.principal
                                            || 0) +
                                        (property.incomeAndExpenses?.interest
                                            || 0)) : 0) +
                                (property.incomeAndExpenses?.tax || 0) +
                                (property.incomeAndExpenses?.waterBill || 0) +
                                (property.incomeAndExpenses?.electricBill || 0)
                        ...
                        <div className="bg-orange-50 p-3 rounded">
                          <div className="font-medium text-orange-800">返済
                          </div>
                ...
                <div className="p-6 bg-gray-100 border-t-2 border-gray-300">
                  ...
                  <div
                    ...
                    <div className="bg-white p-4 rounded-lg shadow">
                      ...
                      <div
                          className="text-2xl font-bold text-gray-800">{totals.count}件
                      </div>
                    </div>
                    <div className="bg-white p-4 rounded-lg shadow">
                      <div className="text-sm text-gray-600">取得価格合計</div>
                      <div
                          className="text-2xl font-bold text-blue-600">{formatPrice(
                          totals.acquisitionPrice)}</div>
                    </div>
                    <div className="bg-white p-4 rounded-lg shadow">
                      <div className="text-sm text-gray-600">家賃収入合計</div>
                      <div
                          className="text-2xl font-bold text-green-600">{formatPrice(
                          totals.rent)}</div>
                    </div>
                    <div className="bg-white p-4 rounded-lg shadow">
                      <div className="text-sm text-gray-600">支出合計</div>
                      <div
                          className="text-2xl font-bold text-red-600">{formatPrice(
                          totals.expenses)}</div>
                    </div>
                    <div className="bg-white p-4 rounded-lg shadow">
                      <div className="text-sm text-gray-600">月収支合計</div>
                      <div className={`text-2xl font-bold ${totals.monthlyProfit
                  ...
                  <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-white p-4 rounded-lg shadow">
                      ...
                      <div className="text-xl font-bold text-blue-600">
                        {formatPrice(
                            Math.round(totals.acquisitionPrice / totals.count))}
                      </div>
                    </div>
                    <div className="bg-white p-4 rounded-lg shadow">
                      <div className="text-sm text-gray-600">平均表面利回り
                      </div>
                      <div className="text-xl font-bold text-indigo-600">
                        {totals.acquisitionPrice > 0
                            ? ((totals.rent * 12 / totals.acquisitionPrice)
                            * 100).toFixed(2) + '%'
                            : '0.00%'}
                      </div>
                    </div>
                    <div className="bg-white p-4 rounded-lg shadow">
                      <div className="text-sm text-gray-600">平均実質利回り
                      </div>
                      <div className="text-xl font-bold text-purple-600">
                        {totals.acquisitionPrice > 0
                            ? (((totals.rent - totals.expenses) * 12
                            / totals.acquisitionPrice) * 100).toFixed(2) + '%'
                            : '0.00%'}
                      </div>
                    </div>
                  </div>
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg">
                    ...
                    <div className="grid grid-cols-1 gap-2">
                      <div><span
                          className="font-medium">プロジェクト名:</span> {selectedProperty.project?.projectName
                          || '未設定'}</div>
                    </div>
                  </div>
                  ...
                  <div className="bg-yellow-50 p-4 rounded-lg">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      <div><span
                          className="font-medium">価格:</span> {formatPrice(
                          selectedProperty.building?.buildingPrice)}</div>
                      <div><span
                          className="font-medium">種別:</span> {selectedProperty.building?.buildingType
                          || '未設定'}</div>
                      <div><span
                          className="font-medium">構造:</span> {selectedProperty.building?.buildingStructure
                          || '未設定'}</div>
                      <div><span
                          className="font-medium">面積:</span> {selectedProperty.building?.buildingSize
                          ? `${selectedProperty.building.buildingSize}㎡`
                          : '未設定'}</div>
                      <div><span
                          className="font-medium">築年月日:</span> {selectedProperty.building?.buildingDate
                          ? new Date(
                              selectedProperty.building.buildingDate).toLocaleDateString(
                              'ja-JP') : '未設定'}</div>
                      <div className="md:col-span-2"><span
                          className="font-medium">備考:</span> {selectedProperty.building?.buildingRemark
                          || '未設定'}</div>
                    </div>
                  </div>
                  ...
                  <div className="bg-purple-50 p-4 rounded-lg">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                      <div><span
                          className="font-medium">家賃収入:</span> {formatPrice(
                          selectedProperty.incomeAndExpenses?.rent)}</div>
                      <div><span
                          className="font-medium">管理費:</span> {formatPrice(
                          selectedProperty.incomeAndExpenses?.managementFee)}
                      </div>
                      <div><span
                          className="font-medium">修繕積立金:</span> {formatPrice(
                          selectedProperty.incomeAndExpenses?.repairFund)}</div>
                      <div><span
                          className="font-medium">管理委託費:</span> {formatPrice(
                          selectedProperty.incomeAndExpenses?.maintenanceCost)}
                      </div>
                      <div><span
                          className="font-medium">元本返済:</span> {formatPrice(
                          selectedProperty.incomeAndExpenses?.principal)}</div>
                      <div><span
                          className="font-medium">利息:</span> {formatPrice(
                          selectedProperty.incomeAndExpenses?.interest)}</div>
                      <div><span
                          className="font-medium">税金:</span> {formatPrice(
                          selectedProperty.incomeAndExpenses?.tax)}</div>
                      <div><span
                          className="font-medium">水道代:</span> {formatPrice(
                          selectedProperty.incomeAndExpenses?.waterBill)}</div>
                      <div><span
                          className="font-medium">電気代:</span> {formatPrice(
                          selectedProperty.incomeAndExpenses?.electricBill)}
                      </div>
                      <div><span
                          className="font-medium">ガス代:</span> {formatPrice(
                          selectedProperty.incomeAndExpenses?.gasBill)}</div>
                      <div><span
                          className="font-medium">火災保険:</span> {formatPrice(
                          selectedProperty.incomeAndExpenses?.fireInsurance)}
                      </div>
                      <div className="md:col-span-3"><span
                          className="font-medium">その他:</span> {selectedProperty.incomeAndExpenses?.other
                          || '未設定'}</div>
                    </div>

                    <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div
                          className="p-3 bg-white rounded border-2 border-purple-200">
                        <div className="text-lg font-bold">
                          <span className="text-purple-800">月間収支: </span>
                          <span className={calculateMonthlyProfit(
                              selectedProperty.incomeAndExpenses) >= 0
                              ? 'text-green-600' : 'text-red-600'}>
                        {formatPrice(calculateMonthlyProfit(
                            selectedProperty.incomeAndExpenses))}
                      </span>
                        </div>
                      </div>
                      <div
                          className="p-3 bg-white rounded border-2 border-indigo-200">
                        <div className="text-lg font-bold">
                      ...
                      <div
                          className="p-3 bg-white rounded border-2 border-pink-200">
                        <div className="text-lg font-bold">
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div className="grid grid-cols-1 gap-4">
                      <div>
                        ...
                        <input
                            ...
                            onChange={(e) => updateEditingProperty('project',
                  ...
                  <div className="bg-green-50 p-4 rounded-lg">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <label
                            className="block text-sm font-medium text-gray-700 mb-2">価格
                          (円)</label>
                        <input
                            type="number"
                      ...
                      <div>
                        <label
                            className="block text-sm font-medium text-gray-700 mb-2">面積
                          (㎡)</label>
                        <input
                            type="number"
                            step="0.01"
                      ...
                      <div className="md:col-span-2">
                        <label
                            className="block text-sm font-medium text-gray-700 mb-2">備考</label>
                        <textarea
                            value={editingProperty.parcel?.parcelRemark || ''}
                            onChange={(e) => updateEditingProperty('parcel',
                                'parcelRemark', e.target.value)}
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
                            rows="3"
                        />
                      </div>
                  ...
                  <div className="bg-yellow-50 p-4 rounded-lg">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                            ...
                            value={editingProperty.building?.buildingPrice
                                || ''}
                            onChange={(e) => updateEditingProperty('building',
                                'buildingPrice', parseInt(e.target.value) || 0)}
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500"
                        />
                      </div>
                      <div>
                        <label
                            className="block text-sm font-medium text-gray-700 mb-2">種別</label>
                        <select
                      ...
                      <div>
                        <label
                            className="block text-sm font-medium text-gray-700 mb-2">構造</label>
                        <select
                      ...
                      <div>
                        <label
                            className="block text-sm font-medium text-gray-700 mb-2">築年月日</label>
                        <input
                            type="date"
                  ...
                  <div className="bg-purple-50 p-4 rounded-lg">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div>
                        <label
                            className="block text-sm font-medium text-gray-700 mb-2">家賃収入
                          (円)</label>
                        <input
                            type="number"
                            value={editingProperty.incomeAndExpenses?.rent
                                || ''}
                            onChange={(e) => updateEditingProperty(
                                'incomeAndExpenses', 'rent',
                      ...
                      <div>
                        <label
                            className="block text-sm font-medium text-gray-700 mb-2">管理費
                          (円)</label>
                        <input
                            type="number"
                            value={editingProperty.incomeAndExpenses?.managementFee
                                || ''}
                            onChange={(e) => updateEditingProperty(
                                'incomeAndExpenses', 'managementFee',
                                parseInt(e.target.value) || 0)}
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500"
                        />
                      </div>
                      <div>
                        <label
                            className="block text-sm font-medium text-gray-700 mb-2">修繕積立金
                          (円)</label>
                        <input
                            type="number"
                      ...
                      <div>
                        <label
                            className="block text-sm font-medium text-gray-700 mb-2">管理委託費
                          (円)</label>
                        <input
                            type="number"
                            value={editingProperty.incomeAndExpenses?.maintenanceCost
                                || ''}
                            onChange={(e) => updateEditingProperty(
                                'incomeAndExpenses', 'maintenanceCost',
                                parseInt(e.target.value) || 0)}
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500"
                        />
                      </div>
                      <div>
                        <label
                            className="block text-sm font-medium text-gray-700 mb-2">元本返済
                          (円)</label>
                        <input
                            type="number"
                      ...
                      <div>
                        <label
                            className="block text-sm font-medium text-gray-700 mb-2">利息
                          (円)</label>
                        <input
                            type="number"
                      ...
                      <div>
                        <label
                            className="block text-sm font-medium text-gray-700 mb-2">税金
                          (円)</label>
                        <input
                            type="number"
                            value={editingProperty.incomeAndExpenses?.tax || ''}
                            onChange={(e) => updateEditingProperty(
                                'incomeAndExpenses', 'tax',
                                parseInt(e.target.value) || 0)}
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500"
                        />
                      </div>
                      <div>
                        <label
                            className="block text-sm font-medium text-gray-700 mb-2">水道代
                          (円)</label>
                        <input
                            type="number"
                      ...
                      <div>
                        <label
                            className="block text-sm font-medium text-gray-700 mb-2">電気代
                          (円)</label>
                        <input
                            type="number"
                            value={editingProperty.incomeAndExpenses?.electricBill
                                || ''}
                            onChange={(e) => updateEditingProperty(
                                'incomeAndExpenses', 'electricBill',
                                parseInt(e.target.value) || 0)}
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500"
                        />
                      </div>
                      <div>
                        <label
                            className="block text-sm font-medium text-gray-700 mb-2">ガス代
                          (円)</label>
                        <input
                            type="number"
                      ...
                      <div>
                        <label
                            className="block text-sm font-medium text-gray-700 mb-2">火災保険
                          (円)</label>
                        <input
                            type="number"
                            value={editingProperty.incomeAndExpenses?.fireInsurance
                                || ''}
                            onChange={(e) => updateEditingProperty(
                                'incomeAndExpenses', 'fireInsurance',
                                parseInt(e.target.value) || 0)}
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500"
                        />
                      </div>
                      <div className="md:col-span-3">
                        <label
                            className="block text-sm font-medium text-gray-700 mb-2">その他</label>
                        <textarea
                            value={editingProperty.incomeAndExpenses?.other
                                || ''}
                            onChange={(e) => updateEditingProperty(
                                'incomeAndExpenses', 'other', e.target.value)}
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500"
                            rows="3"
                        />
                      </div>
